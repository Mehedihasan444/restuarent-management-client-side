    ...
    <div className="max-w-7xl mx-auto my-10">
      <div className="flex justify-between gap-5">
        ...
        <div className="flex-1 space-y-4">
          ...
          <p className="">Made by <span className="font-bold">{food.userName}</span> </p>
          <h1 className="text-4xl font-bold">{food.foodName}</h1>
          <div className="">Country Origin: {food.foodOrigin}</div>
          <p className="">price: ${food.price}.00</p>
          <p className="">Quantity: {food.quantity}</p>

          <Link to={`/foodOrder/${food._id}`}>
          <button
